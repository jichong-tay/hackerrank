...
Complete the defintion of class 'TestCircleArea' which tests the behavior of the 'area' method, as specified:
  -Define test method 'test_circlearea_with_random_number_radius' which creates a circle 'c1' with radius 2.5, and checks if its computed area matches the value 19.63.
