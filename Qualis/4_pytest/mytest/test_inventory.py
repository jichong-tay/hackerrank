...
class TestingInventoryCreation:
    ...
    def test_creating_empty_inventory(self):
        mobInv = MobileInventory()
        assert mobInv.balance_inventory == {}
    ...
    def test_creating_inventory_with_list(self):
        ...
        assert str(exc_info.value) == "Input inventory must be a dictionary"
    ...
    def test_creating_inventory_with_numeric_keys(self):
        ...
        assert str(exc_info.value) == "Mobile model name must be a string"
    ...
    def test_creating_inventory_with_nonnumeric_values(self):
        ...
        assert str(exc_info.value) == "No. of mobiles must be a positive integer"
...
class TestInventoryAddStock:
    ...
    def test_add_new_stock_as_dict(self):
        self.inventory.add_stock(
            {"iPhone Model X": 50, "Xiaomi Model Y": 2000, "Nokia Model A": 10}
        )
    ...
    def test_add_new_stock_as_list(self):
        ...
        assert str(exc_info.value) == "Input stock must be a dictionary"
...
class TestInventorySellStock:
    ...
    def test_sell_stock_as_list(self):
        ...
        assert str(exc_info.value) == "Requested stock must be a dictionary"
    ...
    def test_sell_stock_of_Nonexisting_model(self):
        ...
        assert str(exc_info.value) == "No Stock. New Model Request"
